...
func main() {
	...
	case "throughput":
        ...
        case "rootfs":
		fioBenchmarkFlags = "--name=rootfs --status-interval=30 --numjobs=32 --ioengine=libaio --direct=1 --bs=4k --iodepth=32 --readwrite=randread --directory=/ --size=1G --runtime=60 --time_based --filename=fly-fio"
        case "data":
		fioBenchmarkFlags = "--name=data --status-interval=30 --numjobs=32 --ioengine=libaio --direct=1 --bs=4k --iodepth=32 --readwrite=randread --directory=/data --size=1G --runtime=60 --time_based --filename=fly-fio"
        case "rootfs-ro":
        ...
        case "data-ro":
		fioBenchmarkFlags = "--name=data-ro --status-interval=30 --numjobs=32 --ioengine=libaio --direct=1 --bs=4k --iodepth=32 --readwrite=read --directory=/data --size=1G --runtime=60 --time_based --filename=ly-fio"
        case "data-big":
		fioBenchmarkFlags = "--name=data --status-interval=30 --numjobs=32 --ioengine=libaio --direct=1 --bs=4k --iodepth=64 --readwrite=randread --directory=/data --size=50G --runtime=600 --time_based --filename=fly-fio"
	case "custom":
		break
	default:
		fioBenchmarkFlags = "--name=latency --numjobs=1 --ioengine=libaio --direct=1 --bs=4k --iodepth=1 --readwrite=randrw"
