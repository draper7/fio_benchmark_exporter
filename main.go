...
func main() {
	...
	case "throughput":
        ...
        case "rootfs":
		fioBenchmarkFlags = "--name=rootfs --status-interval=30 --numjobs=1 --ioengine=libaio --direct=1 --bs=128m --iodepth=1 --readwrite=randrw --directory=/ --size=1G --runtime=60 --time_based"
        case "data":
		fioBenchmarkFlags = "--name=data --status-interval=30 --numjobs=1 --ioengine=libaio --direct=1 --bs=128m --iodepth=1 --readwrite=randrw --directory=/data --size=1G --runtime=60 --time_based"
	case "custom":
		break
	default:
		fioBenchmarkFlags = "--name=latency --numjobs=1 --ioengine=libaio --direct=1 --bs=4k --iodepth=1 --readwrite=randrw"
